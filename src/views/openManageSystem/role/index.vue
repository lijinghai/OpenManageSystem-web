...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="角色名称" width="120px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="width: 400px; margin-left:150px;">
        <el-form-item :label="$t('table.role_code')" prop="role_code">
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle, deleteUser } from '@/api/openrole'
...
export default {
  ...
  data() {
    return {
      ...
      pvData: [],
      rules: {
        role_code: [{ required: true, message: '角色必须输入', trigger: 'change' }],
        role_name: [{ required: true, message: '角色名称必须输入', trigger: 'change' }],
        state: [{ required: true, message: '状态必须输入', trigger: 'change' }],
        name: [{ required: true, message: '邮箱必须输入', trigger: 'change' }]
      },
